...
module.exports = [
	{
		...
		description:
			"ジュエリー・アート・エステなど複数の事業を展開する企業グループのコーポレートサイト。静的ページ50ページ超の大規模案件に3名体制のサブとして参加し、ページのコーディングに加え、お知らせ・企業ブログの WordPress 化も担当。",
	},
	{
	...
	},
	{
		...
		description:
			"静的40ページと、診療科紹介の動的ページ100ページからなる大規模案件。全体のコーディングとコンポーネント・定型テンプレートの作成を担当。診療科ページは先方が自分で修正できるよう他社が組み込んだCMSを用いて構築し、記事登録はコーダー5人に指示を出して完了。",
	},
	{
	...
	},
	{
		...
		tech: ["Sass", "JavaScript", "PHP"],
		description:
			"40ページ規模の大学サイトを、他社のコーダーとコミュニケーションを取りながら合同で制作。CMS組み込みは他社が行うため、組み込みやすさを意識したコンポーネント作成・コーディングを担当。",
	},
	{
